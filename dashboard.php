          ...
          <form action="" method="POST" class="form form-horizontal">
            <fieldset>
              ...
              <div class="form-group">
                        ...
                        <div class="col-xs-8">
                  <select name="academic_year" class="selectpicker show-tick" data-width = "100%">
                      <option>A.Y. 2016-2017</option>
          ...
          <form action="" method="POST" class="form form-horizontal">
            <fieldset>
              ...
              <h3><legend class="text-center"><b>ADD TERM</b></legend></h3>
                     ...
                     <div class="form-group">
                          <label class="col-xs-4 control-label" for="term1">Term 1:</label>
                        <div class="col-xs-8">
          ...
          <form action="php/search-faculty.php" method="POST" class="form form-horizontal">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-4">
                  <input class="form-control" id="search-idnumber" name="idNumber" type="text" maxlength="8" style="width:80px;" onkeyup = "autocompletId()">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-7">
                  <input class="form-control" id="search-name" name="fullName" style="float: left; margin-right:5px;" type="text" placeholder="Last Name, First Name" 
                  onkeyup = "autocompletName()" readonly>
              ...
              <div id="inputIDNumDaily">
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input style="width:80px" type="text" class="form-control" id="idnumber" name="idnumber" maxlength="8" onkeyup = "autocompletIdg()" />
                      <ul id = "id-list"></ul>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input style="width:214px" type="text" class="form-control" id="name" name="name" placeholder="Last Name, FirstName" onkeyup = "autocompletNameg()"readonly/>
                      <ul id = "name-list"></ul>
                    </div>
                  </div>
                </div>
